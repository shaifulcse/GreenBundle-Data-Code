...
#### Global variables
order=['acrylicPaintOriginal', 'acrylicPaintBundling', 'acrylicPaintDropping','acrylicPaintOriginal-GM2', 'acrylicPaintBundling-GM2', 'acrylicPaintDropping-GM2']
...
def draw_graph():
	...
	plt.xlabel("Bundling/Dropping Time (ms)",fontsize=16)
	...
	plt.margins(0.1)
	plt.title("AcrylicPaint App", fontsize=22)
	ax.set_ylim(None,18)
	#ax.set_aspect(0.6)
