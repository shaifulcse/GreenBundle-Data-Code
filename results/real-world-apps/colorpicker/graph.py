...
#### Global variables
order=['colorPickerOriginal','colorPickerBundling', 'colorPickerDropping','colorPickerOriginal-GM2','colorPickerBundling-GM2', 'colorPickerDropping-GM2']
...
def draw_graph():
	...
	plt.margins(0.1)
	plt.title("ColorPicker App", fontsize=22)
